...
namespace Forum.App
{
    ...
    internal class MenuController
    {
        ...
        {
            var postController = (PostDetailsController)this.CurrentController;
            var addReplyController = (AddReplyController) this.controllers[(int) MenuState.AddReply];
            addReplyController.SetPostId(postController.PostId);
        ...
        private void AddPost()
        {
            ...
            var postViewr = (PostDetailsController) this.controllers[(int) MenuState.ViewPost];
            postViewr.SetPostId(postId);
